...
class UploadHomeworkScreen extends StatefulWidget {
  ...
  @override
  State<UploadHomeworkScreen> createState() => _UploadHomeworkScreen();
}

class _UploadHomeworkScreen extends State<UploadHomeworkScreen> {
  List homework = []; // empty list
  @override
                  ...
                  InkWell(
                    onTap: () {
                      Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const AddHomeworkAssignmentScreen(),
                          ));
                    },
                    child: Container(
                      width: 208,
